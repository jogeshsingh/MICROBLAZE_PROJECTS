...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../uart_tx.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../uart_tx.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../uart_tx.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../uart_tx.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
